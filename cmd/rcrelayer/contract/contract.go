...
const BridgeBankABI = "/src/github.com/ltacker/request-chain/cmd/rcrelayer/contract/abi/BridgeBank.abi"

// CosmosBridgeABI : path to file containing CosmosBridge smart contract ABI
const CosmosBridgeABI = "/src/github.com/ltacker/request-chain/cmd/rcrelayer/contract/abi/CosmosBridge.abi"
